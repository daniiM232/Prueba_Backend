...
<body>
    <div class="cont1 ancho">
        ...
        &nbsp;|&nbsp;
        <a href="agregar_alum.php">Agregar</a><br>
        <div class="cont_in2">
            <?php 
            ...
            <table class="tabladatos">
                ...
                <tr>
                    ...
                    <td><?php echo $fila["materias"]."<br>";?></td>
                    <td><a href='editar_alum.php?id=<?php echo $fila["id"];?>'>EDITAR</a></td>
                    <td><a href="#" onclick="validar('eliminar_alum.php?id=<?php echo $fila["id"];?>')">Eliminar</a></td>
